	...
	return (
		<Styles currentColor={currentColor} className={currentColor}>
				...
				<div className='twoCol'>
					<div>
						...
						<p>
							...
							Cinemas, but I have worked at Cadre5, Pyxl, Robin Easter, Morris Creative {'&'}{' '}
							DesignSensory.
						</p>
					</div>
			...
			<article>
				...
				<p>
					As designers we use a variety of programs to create interactions. Some of these can produce simple
					code, some of these do not. As developers we can import libraries and packages to create animations.
					Some of these are simple... some are not!
				</p>
				<p>
					The purpose of this talk is to go over some of the easy solutions using simple CSS to trigger
					accessible animations. I'll also go over how we can do this when using React.
				</p>
			</article>
			<article className='twoCol'>
				...
				<figure>
					<img
						...
						alt='example showing a choppy animation and a smooth one that loads in articles'
					/>
				</figure>
			</article>
			<article>
			...
			<article>
				...
				<ul>
					<li>If you've ever tried doing this you've probably walked away annoyed with CSS.</li>
				</ul>
			</article>
			<article>
			...
			<article>
				...
				<ul>
					...
					<li>
						...
						<code>transition: color .2s ease-in, transform 8s ease-in-out; </code>
					</li>
					<li>
			...
			<article>
				...
				<ul>
					<li>
						So now that we have classes, we can use Javascript to “toggle” a CSS class on an HTML element.
						This will make the browser transition between each of the properties.{' '}
						<code>{'.toggle(‘myClass’)'}</code>
					</li>
					<li>
						We can do this a variety of ways, a very easy one is to use Javascript to “listen” to see if an
						HTML element has been clicked. That will trigger our function which will then add or remove the
						CSS class from our element.
			...
			<article>
				...
				<div className='twoCol'>
					...
					<ul>
						<li>This example shows a light to dark color swap using a transition.</li>
						<li>This is purely an example and isn't how you would normally do this.</li>
					</ul>
					<figure className='exampleImg'>
						<img
						...
						/>
						<figcaption>
							Link to this: <a href='https://codepen.io/joyanna/pen/jOPvoeX'>Click this!</a>
						</figcaption>
					</figure>
				</div>
			</article>
			<article>
				...
				<ul>
					<li>
						Instead of querying the DOM for our elements we can have each of those elements update when
