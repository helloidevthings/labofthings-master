...
const CSSAnimations = () => {
 ...
 return (
  <Styles currentColor={currentColor} className={currentColor}>
   ...
   <div>
    <button className='dropplet' aria-haspopup={toolTip} onClick={handleDropplet}>
     💄 Color : {/* <Dropplet /> */}
   ...
   <section>
    ...
    <article className='twoCol'>
     <div>
      ...
      <br />
      <p>
       There's a lot to cover! Feel free to use this webpage as a resource for all of the topics
       we'll be covering.
      </p>
      <hr />
      <ol>
     ...
     <aside>
      ...
      <hr />
      <p>
       I have worked in design and development for over 13 years. I am currently working at Regal
       Cinemas. I have worked at Cadre5, Pyxl, Robin Easter, Morris Creative {'&'} DesignSensory.
      </p>
      <br />
      <p>I love typography, hanging out on the couch with my cat, hot yoga and anything cheese.</p>
      ...
      <figure className='circleCrop'>
       ...
       />
       <figcaption>
        <a href='https://twitter.com/joyannahirst' target='_blank' rel='noreferrer'>
         Follow <Arrow />
        </a>
       </figcaption>
      </figure>
    ...
    <article className='twoCol'>
     <div>
      ...
      <ul>
       ...
       <li>
        Subtle animations provide user feedback. It shows the user your app is actually "doing"
        something.{' '}
       </li>
       <li>
        Either way! If you're using animations, studies show that your users are paying attention.
        Unless... you're using too much, and then they are annoyed.
       </li>
      </ul>
      <br />
      <h4>References</h4>
     ...
     <blockquote>
      In UX, motion and animation can be helpful and communicative, if used with restraint. Motion
      is most often appropriate as a form of subtle feedback for microinteractions, rather than to
      induce delight or entertain users.
      <br />
    ...
    <article className='twoCol'>
     <div>
      <ul>
       ...
       <li>Animations shouldn't get in the way of the functionality of the UI elements</li>
       <li>Animations are different from Mobile to Web</li>
       <li>
        The goal is to animate in a way that makes sense to our brains, by mimicing what we see in
        the real world.{' '}
       </li>
      ...
      <br />
      <a href='https://material.io/design/motion/speed.html' target='_blank' rel='noreferrer'>
       Material Design: Motion <Launch />
      </a>
     </div>
     <blockquote>
      So, if we sum up all of the above-mentioned rules and principles, the animation in the
      interface should reflect the movements that we know from the physical world — friction,
      acceleration, etc. Imitating the behavior of objects from the real world we can create a
      sequence that allows users to understand what to expect from the interface.
      <br />
   ...
   <section>
    ...
    <p>
     <i>
      Here are a few tools and libraries that we use to animate web. (Sorry if your favorite isn't
      listed)
     </i>
    </p>
    <hr />
     ...
     <div>
      ...
      <ul>
       ...
       <li>
        <p>
         Framer:{' '}
         <a href='https://www.framer.com/examples/svg-animation/' target='_blank' rel='noreferrer'>
          SVG Animations
         </a>
        </p>
       </li>
       <li>
        <p>
         <a href='https://docs.animaapp.com/' target='_blank' rel='noreferrer'>
          Anima
         </a>
        </p>
       </li>
   ...
   <section>
    ...
    <p>
     <i>Smart Animate makes it easy to quickly mock-up animations from screen to screen.</i>
    </p>
    <hr />
    <article className='twoCol'>
     <div>
      ...
      <ul>
       ...
       <li>These don't necessarily export code, but there are plugins and other tools.</li>
      </ul>
      <h3>Communication</h3>
      <ul>
       <li>
       ...
       <li>In some cases you can export code, but most likely will need to be looked at.</li>
      </ul>
      <h4>References</h4>
      <ol>
       <li>
     ...
     <div>
      ...
      <figure>
       <img
        ...
        alt=''
       />
       <figcaption>Figma creates the transition between screens</figcaption>
      </figure>
     </div>
    </article>
   </section>
   <section>
    <div>
     ...
     <p>
      <i>
       Helps Designers be able to create complex animations. Exports JSON files for developers to
       use.
      </i>
     </p>
     <hr />
    ...
    <article className='twoCol'>
     <div>
      ...
      <ul>
       ...
       <li>Has plugin support for our favorite programs: Figma, Framer, Webflow, etc</li>
   ...
   <section>
    ...
    <p>
     <i>
      Especially when using Libraries {'&'} Design-to-Dev plugins, we need to be careful of how
      often we use them.
     </i>
    </p>
    <hr />
    <article className='twoCol'>
     ...
     <div>
      ...
      <figure>
       ...
       />
       <figcaption>Actual footage of the browser loading your animations...</figcaption>
      </figure>
     </div>
    </article>
   </section>
   <section>
    ...
    <p>
     This shows two SVG circles that are rotated 360. One is exported using a plugin, the other is
     using CSS. For complex animations this plugin is perfect! In this case, we're asking the
     browser to use JavaScript to constantly re-render a transform.
    </p>
    <br />
    <h3>The "Problem"</h3>
    <p>
     The problem here isn't that we're using javascript instead of CSS. The problem is that we're
     loading an entire library to rotate a circle. If all we want to do is rotate a complicated svg,
     we can do so without loading an entire animation library.
    </p>
    <br />
    <br />
    <article className='twoCol'>
   ...
   <section>
    ...
    <p>
     <i>
      It's not really a matter of JavaScript vs CSS in some cases it's about the same from a
      performance standpoint. (for most modern browsers)
     </i>
    </p>
    <hr />
    <article>
     ...
     <ul>
      <li>With how quickly web changes, it's important to take everything with a grain of salt.</li>
      <li>Each application is different.</li>
     </ul>
     <blockquote>
      CSS transitions/animations are resampling element styles in the main UI thread before each
      repaint event happens, which is almost the same as resampling element styles via a
      <code>requestAnimationFrame()</code> callback, also triggered before the next repaint. If both
      animations are made in the main UI thread, there is no difference performance-wise.
      <br />
      <cite> MDN Web Docs, CSS {'&'} JavaScript Animation Performance • 2022</cite>
     </blockquote>
     <br />
     <blockquote>
      Setting a transform with a 3D characteristic (like translate3d() or matrix3d()) triggers the
      browser to create a GPU layer for that element. So the GPU speed boost is not just for CSS
      animations – JavaScript animation can benefit too!
      <br />
   ...
   <section>
    ...
    <article className='twoCol'>
     <ul>
      ...
      <li>Creating 60FPS by using properties that paint at the end of the process. </li>
     </ul>
     <blockquote>
      “...avoid using transitions with the left/top/right/bottom properties. Those don’t create a
      fluid animation because they have the browser creating layouts each time, which will affect
   ...
   <section>
    ...
    <em>We want all these to be good... Therefore we need to pay attention to our performance.</em>
    <hr />
    <article className='twoCol'>
     <div>
      <h3>Bad UX affects Rankings</h3>
      <em>
       Many factors can play into a site's SEO, it's good to stay up-to-date on what is being
       calculated.{' '}
      </em>
      <ul>
       ...
       <li>Check Lighthouse for your performance score and suggested modifications.</li>
     ...
     <blockquote>
      Lighthouse is an open-source, automated tool for improving the quality of web pages. You can
      run it against any web page, public or requiring authentication. It has audits for
   ...
   <section>
    ...
    <em>Semantic HTML relates the structure of the content to the browser.</em>
    <hr />
    <article className='twoCol'>
     <div>
      <h3>Visual Hierarchy is well... Visual 👀</h3>
      <ul>
       <li>Limited time for crawlers to gain benneficial content from your site</li>
       <li>Text should be in a tag that relates that it is text.</li>
       <li>Negative Scoring will Impact SEO</li>
       <li>You can use plugins to test your accessibility. Axe Dev Tools is a good one.</li>
   ...
   <section>
    <h2>What! No DIVs?</h2>
    <em>you can still use divs, but there are a few things to keep in mind.</em>
    <hr />
    ...
    <article className='twoCol'>
     <div>
      ...
      <ul>
       <li>Is the content semantically related? or is the content self contained.</li>
     ...
     <blockquote>
      When approaching which markup to use, ask yourself, "What element(s) best describe/represent
      the data that I'm going to populate?" For example, is it a list of data?; ordered, unordered?;
      is it an article with sections and an aside of related information?; does it list out
      definitions?; is it a figure or image that needs a caption?; should it have a header and a
      footer in addition to the global site-wide header and footer?; etc.
      <br />
    ...
    <article className='twoCol'>
     <div>
      ...
      <ul>
       ...
       <li>Using Ease or a Bezier Curve defines how the browser transitions between each state</li>
      </ul>
      <h3>Animations</h3>
      <ul>
     ...
     <div>
      ...
      <ul>
       ...
       <li>
        ...
        <code>transition: color .2s ease-in, transform .6s ease-in-out; </code>
       </li>
       <li>
      ...
      <ul>
       ...
       <li>
        Keyframe %<code>{`0%{color: pink} 50%{color: purple} 100%{color:blue}; `}</code>
       </li>
       <li>
        Using Keyframes
   ...
   <section>
    ...
    <article className='twoCol'>
     <div>
      ...
      <p>
       This is the typical way of using CSS transitions with Javascript. With the introduction of
       JavaScript Frameworks. We are able to manage state inside our application.
      </p>
      <br />
      <ol>
       <li>Query The DOM</li>
     ...
     <div>
      ...
      <ul>
       <li>
        So now that we have classes, we can use Javascript to “toggle” a CSS class on an HTML
        element. This will make the browser transition between each of the properties.{' '}
        <code>{'.toggle(‘myClass’)'}</code>
       </li>
       <li>
        We can do this a variety of ways, a very easy one is to use Javascript to “listen” to see if
        an HTML element has been clicked. That will trigger our function which will then add or
    ...
    <figure>
     ...
     />
     <figcaption>
      <a href='https://codepen.io/joyanna/pen/jOPvoeX' target='_blank' rel='noreferrer'>
       View Project <Arrow />
      </a>
     </figcaption>
    </figure>
   ...
   <section>
    ...
    <em>
     Instead of querying the DOM for our elements, we can update elements when there is a state
     change.
    </em>
    <hr />
    <article className='twoCol'>
     ...
     <figure>
      ...
      />
      <figcaption>You can see the pre-generated classes swap out to open the menu.</figcaption>
     </figure>
    </article>
   </section>
   <hr className='dotted' />
   ...
   <section>
    ...
    <article className='twoCol'>
     <div>
      ...
      <blockquote>
       ...
       web content and web applications (especially those developed with JavaScript) more accessible
    ...
    <br />
    <a href='https://reactjs.org/docs/accessibility.html' target='_blank' rel='noreferrer'>
    ...
    <article className='twoCol'>
     <div>
      ...
      <ul>
       ...
       <li>
        Then we can toggle <code>aria-hidden</code> and <code>aria-expanded</code> with our state.
       </li>
       <li>Using these attributes makes it easy for someone using a screen reader. </li>
       <li>
        Additionally you can use <code>id</code> and <code>aria-labelledby</code> to closely pair
        the button and content
       </li>
       <li>
        It's not required to use <code>aria-labelledby</code>, but it helps to create a structure
        that screen readers can pick up on. Similar to labels and inputs.
       </li>
      </ul>
      <h4>References</h4>
      <a href='https://www.aditus.io/patterns/accordion/' target='_blank' rel='noreferrer'>
       Accessible Accordions <Launch />
      </a>
      <br />
      <a href='https://www.w3.org/TR/wai-aria-practices-1.2/' target='_blank' rel='noreferrer'>
    ...
    <article className='twoCol'>
     <div>
      ...
      <ul>
       ...
       <li>You can add those classes to different SVG elements and groups</li>
      </ul>
      ...
      <ol>
       ...
       <li>Copy and Paste the code into a browser-based code editing platform.</li>
       <li>Write some fun CSS Animations. 🤩</li>
      </ol>
      <em>
       There is a lot going on in this particular example. Tons of absolute positioned items and
       pseudo elements. The point here was to show a few svgs animating. ☝️ It's not necessarily the
       most performant example.
      </em>
      <hr />
      <h4>References</h4>
      <a href='https://jakearchibald.github.io/svgomg/' target='_blank' rel='noreferrer'>
       SVGOMG <Launch />
      </a>
      <br />
      ...
      <br />
      <a href='https://codesandbox.io/?from-app=1' target='_blank' rel='noreferrer'>
       CodeSandbox <Launch />
      </a>
      <br />
     </div>
     <figure>
      ...
      />
      <figcaption>
       <a href='https://codepen.io/joyanna/pen/NWGYLNW' target='_blank' rel='noreferrer'>
        View Project <Arrow />
       </a>
      </figcaption>
     </figure>
   ...
   <section>
    ...
    <em>
     One way to utlized Styled Components and Animated SVGs is to save your animations to your theme
     file.
    </em>
    <hr />
    <article>
     ...
     <ul>
      ...
      <li>That way you only load animations when they are present on the page.</li>
     </ul>
     <div className='twoCol'>
      ...
      <figure>
       ...
       />
       <figcaption>Example of bringing animation classes into the svg</figcaption>
      </figure>
      <figure>
       <img
        className='smallFig'
   ...
   <section>
    ...
    <article>
     ...
     <ul>
      ...
      <li>If we use libraries or plugins, let's make sure it's justified.</li>
      <li>Animations add to our UX, let's be mindful of how we use them.</li>
     </ul>
    </article>
    <br />
    <hr />
